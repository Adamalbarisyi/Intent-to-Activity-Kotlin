...
class SecondActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val intent = intent
        val list = intent.getParcelableExtra<ListClub>(POSITIONEXTRA)

        SecondActivityUI(list).setContentView(this)

    }

    internal class SecondActivityUI(var list: ListClub) : AnkoComponent<SecondActivity>{
        ...
        override fun createView(ui: AnkoContext<SecondActivity>) = with(ui){
            ...
            linearLayout {
                ...
                imageView {
                    ...
                    id = MainActivity.FootballUI.imageId
                    padding = dip(10)
                ...
                textView{
                    id = MainActivity.FootballUI.nameId
                    text = list.nama
